...
# cmdline.execute(("scrapy crawl naver_news_spider -a start_date="+start_date+" -a end_date="+end_date+\
#                 " -a scraping_count_goal="+str(scraping_count_goal)).split())

cmdline.execute(("scrapy crawl naver_news_spider -a start_date=2021-09-06 -a end_date=2021-09-12"\
                " -a scraping_count_goal="+str(scraping_count_goal)).split())
